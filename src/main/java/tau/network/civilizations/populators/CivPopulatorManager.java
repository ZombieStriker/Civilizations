...
public class CivPopulatorManager {
    ...
    private static final HashMap<CivBiomes, List<CivPopulator>> populators = new HashMap<>();

    private static final HashMap<ChunkPosition, List<BlockDataHolder>> toBeReplacedWith = new HashMap<>();

    public static void setHoldoverBlock(World world, final int x, final int y, final int z, int chunkx, int chunkz, final Material material) {
